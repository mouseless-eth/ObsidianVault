...
Instructions for control flow (non linear code execution)
```
STOP      //Halt execution
...
Opcodes dealing with the execution environment information
```
...
#### Block Operations
Opcodes for accessing information about the current block
```
